document.addEventListener("DOMContentLoaded", () => {
    ...
    const menuTrigger = document.getElementById('mobile-menu-trigger-js');
    const navLinks = document.getElementById('nav-links-js');
    const mobileNavMenu = document.getElementById('mobile-nav-js');
    ...
    // =================================
    navLinks.onclick = () => {
        mobileNavMenu.classList.remove("mobile-menu-js--visible");
        menuTrigger.classList.remove("mobile-menu-button-js--visible");
        body.classList.remove("scrollable-js--disabled");
    }
